function braintell_menu_selector()
        ...
        while (isempty(reply))
            ...
            if strcmp(reply, '!')
                ...
                if(fid == -1)
                    ...
                    fclose(fid);
                    braintell_shuffle_both_constraints(reply, 'Anterior Area');
                end
            end            
        end
        ...
        while (isempty(reply))
            ...
            if strcmp(reply, '!')
                ...
                if(fid2 == -1)
                    ...
                    randFileName = braintell_shuffle_both_constraints(binFileName, reply2);
                ...
                if(fid2 == -1)
                    ...
                    if(count == 0)
                       disp('Exiting'); 
                        ...
                        [p, stats] = create_scaled_histogram(binDifferences, randDifferences, '-');
                    end
                end
            end                              
        end  
        ...
        while (isempty(reply))
            ...
            if strcmp(reply, '!')
                ...
                if(fid2 == -1)
                    ...
                    fclose(fid2);
                    idClusters = hierarchical_clustering(reply, 'Presubiculum');
